...
class TreatmentResultModel extends TreatmentResult {
  TreatmentResultModel({
  ...
  factory TreatmentResultModel.fromJson(Map<String, dynamic> json) {
    return TreatmentResultModel(
