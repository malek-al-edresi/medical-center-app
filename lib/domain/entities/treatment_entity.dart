class TreatmentEntity {
  ...
  final String diagDetails;
  final String doctorNotes;
  final String treatmentDescription;
  final String drugName;
  final String contraDesc;
  final String contraList;
  ...
  const TreatmentEntity({
    ...
    required this.diagDetails,
    required this.doctorNotes,
    required this.treatmentDescription,
    required this.drugName,
    required this.contraDesc,
    required this.contraList,
    required this.departmentName,
    required this.sideEffectDescription,
